...
<body>
    ...
    <?php
        ...
        if (isset($_POST['btnSignUp'])) {
            if ($_SERVER['REQUEST_METHOD'] == "POST"){
                ...
                if (strlen($_POST['txtPassword']) < 8){
                    $txtPasswordErr = "Password must be atleast 8 characters long";
                ...
                if ($passwordIsset == true && $phoneIsset == true && $emailIsset == true){
                    ...
                    $sql = "INSERT INTO users VALUES(null, '$txtFirstname', '$txtOthernames', '$txtUsername', '$txtPassword', '$txtAddress', '$txtBirthday', '$txtGender', '$txtPhone', '$txtEmail', '$profilePix')";
        ...
        <a href="homepage.php"><img src="Img/Ouspace-logo.png " width="145px " height="35px " alt="FutatweetsLogo" style="margin:10px 0px 10px 20px"></a>
                    ...
                    <div class="signUpTxt" id="#signUp">
                        <form method="post">
                            <center>
                                ...
                                <div class="form-group">
                                    <label for="txtOthernames">Last Name</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <span style="color:#a6a6a6; font-size:12px; float:left;">(e.g: Palm Beach, Boca Raton, etc.)</span>
