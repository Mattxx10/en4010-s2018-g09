        ...
        <div class="row">
            <div class="col-md-6 col-md-push-3 cusContainer" style="padding:0px;">
                ...
                <div class="icon-bar">
                    ...
                    <a href="newTweet.php" style="color:white; background-color: #0066cc;" href="homepage.php">New Post</i></a>
                    ...
                    <?php
                        if (isset($_POST['btnTweet'])){
                            if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                                ...
                                $createTwQuery = "INSERT INTO tweets VALUES(null,'$txtTweetName', '$txtTweetImg', '$txtNewTweet',0, CURRENT_TIMESTAMP)";
